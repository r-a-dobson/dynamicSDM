...
In our case study, we use a raster of various biomes in southern Africa and split large biomes by 3 degree cells. 
The function has returned the original data frame with an additional column containing the block numbers that each record belongs to. 
...
##### Note: if you want to use other modelling approaches, this data frame of response and explanatory variable data can easily be input into SDM functions in other packages.
