...
projectionrasters <- file.path(file.path(project_directory, "projectionrasters"))
 
projection_covariates <- file.path(file.path(project_directory, "projectioncovariates"))
  
projection_GIF <- file.path(file.path(project_directory, "projection_GIF"))
```
...
https://github.com/r-a-dobson/dynamicSDM/blob/main/man/figures/dynamicSDM_1.0.pdf).
