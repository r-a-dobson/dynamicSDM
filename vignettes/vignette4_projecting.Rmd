...
sp::plot(terra::rast(list.files(projection_directories)[1]))
sp::plot(terra::rast(list.files(projection_directories)[2]))
sp::plot(terra::rast(list.files(projection_directories)[3]))
sp::plot(terra::rast(list.files(projection_directories)[4]))
```
...
https://github.com/r-a-dobson/dynamicSDM/blob/main/man/figures/dynamicSDM_1.2.pdf).
