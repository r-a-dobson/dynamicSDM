...
#' @examples
#' Identifies missing "year" column in species occurrence record data frame
#'
...
#'
#'Returns: message - "Error in spatiotemp_check(occ.data) : year column not found. Ensure the column containing species record year is named 'year'"
#'
#'Removes record with invalid dates (90th April 2015) from species occurrence record data frame
#'
#'x<-c(27.79125, 28.54125, 25.54125, 30.04125, 29.95792)
#'y<-c(-26.79125, -26.37458, -26.70792, -29.37458, -28.45792)
#'year<-c(2014, 2016, 2011, 2011, 2015)
#'month<-c(1, 2, 3, 2, 4)
#'day<-c(27, 25, 16, 25, 90)
#'occ.data<-data.frame(cbind(x,y,year,month,day))
#'spatiotemp_check(occ.data,date.handle="exclude")
#'Returns:
#'  x         y        year month day
